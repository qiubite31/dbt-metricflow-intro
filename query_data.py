...
def query_database():
    ...
    try:
        ...
        df_customers = conn.execute(customers_query).df()
...
def query_customers_with_orders():
    ...
    try:
        ...
        # 3. Print results
        print("\nResults from 'customers_with_orders' (direct DuckDB query):")
        print(df_results)
...
def query_customer_order_detail():
    ...
    try:
        ...
        # 3. Print results
        print("\nResults from 'customer_order_detail' (direct DuckDB query):")
        print(df_results)
